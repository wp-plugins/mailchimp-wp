...
$layout = array(
	...
	'editables' => array(
		...
		'headline' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_headline_copy_wrapper' => array(
				'font-size' => array( __('Font Size'), '25px'),
				'color' => array( __('Font Color'), '#2B6B98'),
			),
		),
		'description' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_description_copy_wrapper p' => array(
				'font-size' => array( __('Font Size'), '14px'),
				'color' => array( __('Font Color'), '#6D6D6D'),
			),
		),
		'name_field' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_name_field_wrapper, .fca_eoi_postbox_1 .fca_eoi_postbox_1_name_field_wrapper input' => array(
				'color' => array( __( 'Font Color' ), '#7f7f7f' ),
				'background-color' => array( __( 'Background Color' ), '#F5F5F5' ),
			),
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_name_field_wrapper' => array(
				'border-color' => array( __('Border Color'), '#CCC'),
			),
		),
		'email_field' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_email_field_wrapper, .fca_eoi_postbox_1 .fca_eoi_postbox_1_email_field_wrapper input' => array(
				'color' => array( __( 'Font Color' ), '#7f7f7f' ),
				'background-color' => array( __( 'Background Color' ), '#F5F5F5'),
			),
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_email_field_wrapper' => array(
				'border-color' => array( __( 'Border Color' ), '#CCC'),
			),
		),
		'button' => array(
		...
		'privacy' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_privacy_copy_wrapper' => array(
				'font-size' => array( __('Font Size'), '14px'),
				'color' => array( __('Font Color'), '#8F8F8F'),
			),
		),
		'fatcatapps' => array(
			'.fca_eoi_postbox_1 .fca_eoi_postbox_1_fatcatapps_link_wrapper a, .fca_eoi_postbox_1 .fca_eoi_postbox_1_fatcatapps_link_wrapper a:hover' => array(
	...
	'autocolors' => array(
		array(
			'source' => '[.fca_eoi_postbox_1 .fca_eoi_postbox_1_submit_button_wrapper input][background-color]',
			'destination' => '[.fca_eoi_postbox_1 .fca_eoi_postbox_1_submit_button_wrapper input][border-color]',
			'operations' => array(
		...
		'source' => '[.fca_eoi_postbox_1 .fca_eoi_postbox_1_submit_button_wrapper input][background-color]',
			'source' => '[.fca_eoi_postbox_1 .fca_eoi_postbox_1_submit_button_wrapper input][background-color]',
			'destination' => '[.fca_eoi_postbox_1 .fca_eoi_postbox_1_submit_button_wrapper input:hover][background-color]',
			'operations' => array(
